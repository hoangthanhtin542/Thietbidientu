                                ...
                                <form class="mx-1 mx-md-4" action="" method="post">
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-3">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            ...
                                            <input name="password" type="password" id="form-control" class="form-control" required="required"/>
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-3">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            ...
                                            <input type="password" name="repassword" id="form-control" class="form-control" required="required"/>
